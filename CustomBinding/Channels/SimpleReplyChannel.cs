...
namespace CustomBinding.Channels
{
    public class SimpleReplyChannel : SimpleChannelBase, IReplyChannel
    {
        ...
        public IReplyChannel InnerReplyChannel { get { return (IReplyChannel)this.InnerChannel; } }

        public SimpleReplyChannel(ChannelManagerBase channelManager, IReplyChannel repleChannel)
            : base(channelManager, (ChannelBase)repleChannel)
        {
            this.Print("SimpleReplyChannel()");
        }

        #region IReplyChannel 成员
        ...
        {
            this.Print("BeginReceiveRequest(timeout)");
        ...
        {
            this.Print("ReceiveRequest(timeout)");
