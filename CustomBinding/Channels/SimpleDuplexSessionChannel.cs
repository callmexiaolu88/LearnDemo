...
namespace CustomBinding.Channels
{
    ...
    {
        public IDuplexSessionChannel InnerDuplexSessionChannel { get { return (IDuplexSessionChannel)this.InnerChannel; } }
        ...
        {
            this.Print("BeginReceive(timeout)");
        ...
        #region ISessionChannel<IDuplexSession> 成员
